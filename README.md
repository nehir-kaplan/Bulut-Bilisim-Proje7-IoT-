...
* **Görsel 3: AWS IoT Core Üzerinde Oluşturulan Akilli_Sehir_Sensoru Nesnesi (Thing)** ![AWS Thing](ss3_aws_thing.png.png)
* **Görsel 4: AWS IoT Core Üzerinde Güvenlik Yetkilendirmeleri Tanımlanan Akilli_Sehir_Politikasi (Policy)** ![AWS Policy](ss4_aws_policy.png.png)
